...
class BaseClass:
    def __init__(self,
        ...
        Args:
            ...
            unit (float, optional): It is referenced with meters, then we can select mm by setting it to 1e-3.
            Defaults to 1e-3.
        """
    ...
    def fourier_transform_2D(self, output_unit: float = 1) -> "BaseClass":
        ...
        Here we calculate its fourier transfrom in 2D, and we keep track of the sample 2D array in this Fourier
        transfrom domain.
